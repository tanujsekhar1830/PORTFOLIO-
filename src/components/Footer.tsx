        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-slate-900">
          ...
          <div className="space-y-1 text-center md:text-left">
            <div className="text-base font-bold text-white tracking-tight flex items-center justify-center md:justify-start gap-2.5">
              {photoUrl ? (
                <div className="w-7 h-7 rounded-lg overflow-hidden border border-cyan-500/40 shadow-sm bg-slate-900 shrink-0">
                  <img
                    src={photoUrl}
                ...
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/40 shadow-sm flex items-center justify-center text-cyan-400 font-bold text-xs font-mono shrink-0">
                  TS
                </div>
              )}
